# vivado-project-mode-tcl Specification

## Purpose
Defines the Vivado GUI-runnable project-mode Tcl flow used to create the eDRAM FPGA test platform project, add RTL and constraints, run xsim smoke simulation, and drive synthesis, implementation, and bitstream generation.
## Requirements
