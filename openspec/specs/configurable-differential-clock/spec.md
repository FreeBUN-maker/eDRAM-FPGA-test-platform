# configurable-differential-clock Specification

## Purpose
Defines the board-level differential clocking capability that receives the AXU5EVB-E PL 200 MHz differential clock, generates a parameterized single-ended core clock, and safely releases the existing RTL core from reset.
